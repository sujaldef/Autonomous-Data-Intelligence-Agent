      ...
      <section className="relative z-10 min-h-screen flex flex-col justify-center px-6 md:px-20 max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <Lock className="text-[#98465f]" size={14} />
            <span className="text-[9px] tracking-[0.4em] uppercase text-slate-500 font-bold">
              System Topology
            </span>
          </div>

          <h1 className="text-5xl md:text-6xl font-light tracking-[-0.04em] leading-[1.1] text-white mb-6">
            Five Layers of <br />
          ...
          <p className="text-slate-400 text-sm md:text-base font-light leading-relaxed max-w-lg border-l border-white/10 pl-6">
            ADIA physically separates reasoning from execution. The LLM acts as
            the brain, planning steps, while independent tools execute math to
            eliminate hallucination.
            <br />
            <br />
            <span className="text-[10px] uppercase tracking-widest text-[#98465f] font-bold">
              Scroll to inspect architecture &darr;
            </span>
          </p>
        </motion.div>
      </section>
