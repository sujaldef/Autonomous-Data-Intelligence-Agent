...
const projectCatalog = {
  'q4-revenue-analysis': { name: 'Q4 Revenue', id: 'PRJ-1024', status: 'Active', color: 'bg-emerald-500' },
  'customer-feedback-engine': { name: 'Feedback', id: 'PRJ-1187', status: 'Processing', color: 'bg-violet-500' },
  'inventory-audit-2024': { name: 'Audit 2024', id: 'PRJ-1402', status: 'Completed', color: 'bg-sky-500' },
  'churn-prediction-model': { name: 'Churn AI', id: 'PRJ-1520', status: 'Idle', color: 'bg-slate-500' },
};
...
const ProjectLayout = () => {
  ...
  const project = projectCatalog[projectId] || { name: 'Workspace', id: 'PRJ-000', color: 'bg-cyan-500' };
      ...
      <aside className="w-20 lg:w-64 flex flex-col bg-[#050912] border-r border-white/5 z-20">
        ...
        <div className="p-6">
          <div className="flex items-center gap-4">
            <div className={`h-3 w-3 rounded-full ${project.color} shadow-[0_0_10px_rgba(0,0,0,0.5)]`} />
        ...
        <nav className="flex-1 px-4 space-y-2">
          <div className="hidden lg:block px-3 mb-4">
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-600">Operations</span>
          </div>
        ...
        <div className="p-6 mt-auto border-t border-white/5 bg-slate-950/30">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden lg:block">
              ...
              <p className="text-xs font-bold text-white">Live & Synchronized</p>
            </div>
          </div>
        </div>
      </aside>
        ...
        <header className="h-14 shrink-0 flex items-center justify-between px-8 border-b border-white/5 bg-[#020617]/50 backdrop-blur-md sticky top-0 z-10">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-lg">
              ...
              <span className="text-[10px] font-mono font-bold text-slate-300">SQL_MASTER_DB</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-lg">
              <Cpu size={14} className="text-cyan-400" />
              <span className="text-[10px] font-mono font-bold text-slate-300">ADIA_v3.2_OAI</span>
            </div>
          </div>
